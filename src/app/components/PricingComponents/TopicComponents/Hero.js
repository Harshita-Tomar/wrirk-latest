        ...
        <>
            ...
            <div className='flex justify-between items-center w-full 2xl:px-10 xl:px-10 lg:px-10 md:px-6 sm:px-4 px-4 py-4 bg-[#2E8095]'>
				<div className='2xl:leading-[44px] xl:leading-[44px] lg:leading-[44px] md:leading-[36px] sm:leading-[30px] leading-[30px]'>
					<h3 className='2xl:text-[42px] xl:text-[42px] lg:text-[42px] md:text-[36px] sm:text-[30px] text-[28px] text-white font-black tracking-wide'>Topic DESCPRITION </h3>
				</div>
            ...
            <div className='w-full py-6 2xl:px-10 xl:px-10 lg:px-10 md:px-10 sm:px-6 px-4'>
                ...
                <div className='grid 2xl:grid-cols-3 xl:grid-cols-3 lg:grid-cols-3 sm:grid-cols-1 grid-cols-1 gap-5'>
                    ...
                    <div className='2xl:col-span-2 xl:col-span-2 lg:col-span-2 md:col-span-1 sm:col-span-1 col-span-1'>
                        ...
                        <div className='rounded-lg shadow-custom3 p-4'>
                            ...
                            <div id="default-tab-content">
                                ...
                                <div className="p-0" id="admission" role="tabpanel" aria-labelledby="admission-tab">
                                    ...
                                    <div className="flex items-center py-2 mt-2 2xl:text-[14px] xl:text-[14px] lg:text-[14px] md:text-[14px] sm:text-[12px] text-[12px]">
                                        <input id="default-checkbox" type="checkbox" value="" name="default-checkbox" className="cursor-pointer w-6 h-6 me-4 rounded-0 text-[#2E8095] bg-[#2E8095] border-[#2E8095] focus:ring-[#2E8095] focus:ring-1" checked />
                                        <label for="default-checkbox" className="font-medium text-black"> Document</label>
                                    </div>

                                    <div className="flex items-center py-2 2xl:text-[14px] xl:text-[14px] lg:text-[14px] md:text-[14px] sm:text-[12px] text-[12px]">
                                        <input id="default-checkbox" type="checkbox" value="" name="default-checkbox" className="cursor-pointer w-6 h-6 me-4 rounded-0 text-[#2E8095] bg-[#2E8095] border-[#2E8095] focus:ring-[#2E8095] focus:ring-1" />
                                        <label for="default-checkbox" className="font-medium text-black"> Technical Description</label>
                                    </div>
                        ...
                        {/* Quantity */}
                        <div className='rounded-lg shadow-custom3 p-4 mt-6'>

                            <div className="p-0">
                                <ul className="flex flex-wrap 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[14px] sm:text-[12px] text-[12px] font-bold text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                                    <li className="me-2" role="presentation">
                                        <button className="inline-block p-1 border-b-2 border-[#064454] rounded-t-lg text-sky-950" id="admission-tab" data-tabs-target="#admission" type="button" role="tab" aria-controls="admission" aria-selected="false">Quantity</button>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div id="default-tab-content">
                                ...
                                <div className="p-0" id="admission" role="tabpanel" aria-labelledby="admission-tab">
                                    ...
                                    <div className='flex items-center justify-start py-1 gap-6 w-2/3 2xl:text-[14px] xl:text-[14px]  lg:text-[14px] md:text-[14px] sm:text-[12px] text-[12px]'>
                                        <div className='w-1/3'>Quantity Description</div>
                                        <div className='w-2/3 '>
                                            <form className="max-w-xs mx-auto">
                                                <div className="relative flex items-center max-w-[6rem]">
                                                    <button type="button" id="decrement-button" data-input-counter-decrement="review-input" className="bg-[#2E8095] mt-2 hover:bg-[#064454] border border-[#2E8095] rounded-md p-1 h-6 focus:ring-[#2E8095] focus:ring-2 focus:outline-none flex items-center justify-center text-[14px] text-white">
                                                        <RiSubtractLine />
                                                    </button>
                                                    <input type="text" id="review-input" data-input-counter data-input-counter-min="1" data-input-counter-max="100" aria-describedby="helper-text-explanation" className="bg-transparent mt-2 h-8 font-medium text-center text-black text-sm block w-full" placeholder="" value="2" required />
                                                    <button type="button" id="increment-button" data-input-counter-increment="review-input" className="bg-[#2E8095] mt-2 hover:bg-[#064454] border border-[#2E8095] rounded-md p-1 h-6 focus:ring-[#2E8095] focus:ring-2 focus:outline-none flex items-center justify-center text-[14px] text-white">
                                                        <RiAddLine />
                                                    </button>
                                                </div>
                                            </form>
