...
import ThesisImplementation from './ThesisImplementation';
import ThesisStatistical from './ThesisStatistical';
import ThesisMapping from './ThesisMapping';

const ThesisImplementationTab = () => {
	return (
		<div>
...
export default ThesisImplementationTab
