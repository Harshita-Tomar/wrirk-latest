    ...
    return (
        <div>
            ...
            <div className='w-full py-2'>
                ...
                <div className="mb-4 ">
                    <ul className="overflow-x-auto flex 2xl:text-[14px] xl:text-[14px] lg:text-[14px] md:text-[14px] sm:text-[12px] text-[12px] font-bold text-center whitespace-nowrap" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
