        ...
        <>
            <div className='w-full'>
                ...
                <div className='grid items-center justify-center w-full bg-[rgb(42,150,177)] rounded-tl-[25px] relative 2xl:pb-14 xl:pb-14 lg:pb-12 md:pb-10 sm:pb-8 pb-8'>
                    <h6 className='font-bold 2xl:text-[27px] xl:text-[27px] lg:text-[24px] md:text-[22px] sm:text-[16px] text-[16px] text-white tracking-wide 2xl:leading-[42.93px] xl:leading-[42.93px]lg:leading-[32.93px] md:leading-[30.93px] sm:leading-[29.93px] leading-[29.93px] py-3 flex justify-center items-center'>Elevate Your Success with Expert Writing Solutions</h6>
                    <h1 className='font-extrabold 2xl:text-[136px] xl:text-[136px] lg :text-[130px] md:text-[100px] sm:text-[70px] text-[70px] 2xl:leading-[136.2px] xl:leading-[136.2px] lg:leading-[136.2px] md:leading-[90.93px] sm:leading-[70.93px] leading-[70.2px] pb-2 text-white tracking-wide opacity-35'>Our Services</h1>
