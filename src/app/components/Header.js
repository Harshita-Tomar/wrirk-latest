        ...
        <div className='2xl:flex xl:flex lg:flex md:hidden sm:hidden hidden gap-7 items-center'>
          ...
          <div id="dropdownHover" className="z-10 hidden bg-[#2E8095] divide-y divide-gray-100 rounded-lg shadow w-52">
            <ul className="py-2  text-sm " aria-labelledby="dropdownHoverButton">
              ...
              <li>
                <Link href="/Pricing/Thesis" className="block px-4 py-2 text-white hover:text-black hover:bg-white">Thesis</Link>
              </li>
              <li>
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              <ul id="dropdown-example" className="hidden py-2">
                ...
                <li>
                  <Link href="/Pricing" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Main</Link>
                </li>
                <li>
                  <Link href="/Pricing/AdmissionProposal" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Admission Proposal</Link>
                </li>
                <li>
                  <Link href="/Pricing/Book" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Book</Link>
                </li>
                <li>
                  <Link href="/Pricing/Implementation" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Implementation/ Analysis</Link>
                </li>
                <li>
                  <Link href="/Pricing/MasterDissertation" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Master Dissertation</Link>
                </li>
                <li>
                  <Link href="/Pricing/Paper" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Paper</Link>
                </li>
                <li>
                  <Link href="#" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Publication</Link>
                </li>
                <li>
                  <Link href="/Pricing/Synopsis" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Research Proposal/ Synopsis</Link>
                </li>
                <li>
                  <Link href="/Pricing/ReviewDoc" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Review On Document</Link>
                </li>
                <li>
                  <Link href="/Pricing/Thesis" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Thesis</Link>
                </li>
                <li>
                  <Link href="#" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Topic Description</Link>
                </li>
                <li>
                  <Link href="#" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Wrirk Membership</Link>
                </li>
                <li>
                  <Link href="/Pricing/Writing" className="flex items-center text-white w-full p-2 transition duration-75 rounded-lg hover:bg-gray-100 hover:text-[#2E8095] ">Writing</Link>
                </li>
              </ul>
            </li>
          ...
          <div className='container'>
            <div className='fixed bottom-[15px] right-[8%] origin-bottom '>
              <Link href="/ContactUs" className="flex items-center justify-center ring-2 ring-white text-white py-2 px-6 rounded-lg bg-[#2E8095] hover:bg-gray-100 hover:text-[#2E8095]">
