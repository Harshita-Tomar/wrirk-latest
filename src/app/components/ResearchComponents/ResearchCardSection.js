...
const ResearchCardSection = () => {
  const data = [
    ...
    {
      title: "The Study on the role of CSR in developing a company's brand development#2",
      desc: "A company's corporate brand will always be representative of a favourable image. When customer's vendors, and even workers and investors have a favourable.",
      category: "Business-Management-And-Accounting",
      keywords: ['Barriers', 'Product'],
    },
    {
      title: "The Study on the role of CSR in developing a company's brand development#3",
      desc: "A company's corporate brand will always be representative of a favourable image. When customer's vendors, and even workers and investors have a favourable.",
      category: "Business-Management-And-Accounting",
      keywords: ['Barriers', 'Product'],
    },
    {
      title: "The Study on the role of CSR in developing a company's brand development#4",
      desc: "A company's corporate brand will always be representative of a favourable image. When customer's vendors, and even workers and investors have a favourable.",
      category: "Business-Management-And-Accounting",
      keywords: ['Barriers', 'Product'],
    },
  ...
  return (
    <>
      <div className='w-full'>
        <div className='grid items-center justify-center w-full bg-[rgb(42,150,177)] rounded-tl-[25px] relative 2xl:py-8 xl:py-8 lg:py-6 md:py-5 sm:py-4 py-4 mt-[-19px]'>
