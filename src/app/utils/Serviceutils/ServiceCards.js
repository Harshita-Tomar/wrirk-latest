    ...
    return (
        <div>
            <div className="max-w-sm mb-5 bg-white border border-sky-400 rounded-lg shadow">
                ...
                <div className="p-4">
                    <a href="#">
                        <h5 className="mb-2 text-[16px] leading-6 font-medium font-poppins text-[#0F3D49]">Thesis Writing</h5>
                    </a>
                    <p className="mb-2 text-[14px] font-normal font-roboto text-[#000000] leading-[25.42px]">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
