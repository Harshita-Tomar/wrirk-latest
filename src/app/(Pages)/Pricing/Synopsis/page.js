...
import Hero from '@/app/components/PricingComponents/SynopsisComponents/Hero';
...
const page = () => {
	return (
		<div>
			...
			<div className='flex justify-between items-center w-full px-4 py-4 bg-[#2E8095] 2xl:px-10 xl:px-10 lg:px-10 md:px-6 sm:px-4 h-[130px]'>
